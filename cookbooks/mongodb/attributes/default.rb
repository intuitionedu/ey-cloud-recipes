...
default[:mongo_utility_instances] = node[:utility_instances].select { |ui| ui[:name][/mongodb_repl/] } 
default[:mongo_replset] = "myi"
default[:mongo_arbiter] = node[:master_app_server][:private_dns_name]